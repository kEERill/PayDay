package com.keerill.payday.item.base;

import com.keerill.payday.block.base.BlockSlabBase;
...
public class ItemSlabBase extends ItemSlab
{
    ...
    public ItemSlabBase(Block block, BlockSlabBase singleSlab, BlockSlabBase doubleSlab)
    {
    ...
    protected <T extends Comparable<T>> IBlockState makeState(IBlockState state, IProperty<T> p_185055_1_, Comparable<?> p_185055_2_) {
        return super.makeState(p_185055_1_, p_185055_2_)
                .withProperty(BlockSlabBase.FACING, state.getValue(BlockSlabBase.FACING));
    }
}
